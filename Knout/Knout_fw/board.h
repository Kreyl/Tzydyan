...
#define USB_AF          AF10
#define USB_DETECT_PIN  GPIOA, 10
...
// Npx LEDs
#define NPX_CNT         176 // Used in Effects
#define NPX_PER_BAND    (NPX_CNT/2)
#define NPX_SPI         SPI3
#define NPX_DATA_PIN    GPIOB, 5, AF6
#define NPX_PWR_PIN     GPIOB, 8
